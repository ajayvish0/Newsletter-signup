...
app.post("/", function(req, res) {
  ...
  var options = {
    url: "https://us18.api.mailchimp.com/3.0/lists/ee81d5d612",
    method: "post", //posting data to mailchimp

    headers: {
      "authorization": "ajay b3a61388cfd97875d78a89b031488016-us18" //http authorization to api using node & request
    },
